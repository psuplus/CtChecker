...
$LEVEL/Debug+Asserts/bin/clang -O0 -g -emit-llvm -o aes.bc -c aes.c
$LEVEL/Debug+Asserts/bin/clang -O0 -g -emit-llvm -o DSExample.bc -c DSExample.c
$LEVEL/Debug+Asserts/bin/llvm-dis -o test.ll test.bc
