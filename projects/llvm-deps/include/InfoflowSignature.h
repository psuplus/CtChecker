...
public:
  ...
  virtual std::pair<std::vector<FlowRecord>, std::vector<FlowRecord>> process(const ContextID ctxt, const ImmutableCallSite cs) const = 0;
...
public:
  ...
  std::pair<std::vector<FlowRecord>, std::vector<FlowRecord>> process(const ContextID ctxt, const ImmutableCallSite cs);
private:
