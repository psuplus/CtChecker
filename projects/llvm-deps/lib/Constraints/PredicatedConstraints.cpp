...
std::vector<Predicate*> Predicate::partitionsubsetPredicatePair(Predicate *P1 
                                                        ,Predicate *P2) {
...
long Predicate::sub1_extend(long x) { return (x == P_NEGINF) ? P_NEGINF : (x - 1); }


bool Predicate::predcompare(Predicate *P1, Predicate *P2) {
  unsigned long size = std::min(P1->pred->intervals.size(), 
                                      P2->pred->intervals.size());
