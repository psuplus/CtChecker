...
$LEVEL/Debug+Asserts/bin/llvm-as devices.ll
$LEVEL/Debug+Asserts/bin/llvm-as selection.ll
$LEVEL/Debug+Asserts/bin/llvm-as property.ll

$LEVEL/Debug+Asserts/bin/llvm-link dixutils.bc resource.bc devices.bc selection.bc property.bc -o $1
