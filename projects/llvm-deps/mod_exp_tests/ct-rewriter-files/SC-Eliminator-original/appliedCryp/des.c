...
inline void cpkey(register unsigned long *into) __attribute__((always_inline))
{
...
inline void usekey(register unsigned long *from) __attribute__((always_inline))
{
...
static void desfunc(register unsigned long *keys, register unsigned long *block)
{
