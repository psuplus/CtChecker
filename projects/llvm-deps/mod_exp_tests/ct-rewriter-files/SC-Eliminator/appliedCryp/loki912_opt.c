...
static __MSALIGN__(64) struct l_array_24_uint8_t in_key __attribute__((aligned(64))) = { "\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" };
