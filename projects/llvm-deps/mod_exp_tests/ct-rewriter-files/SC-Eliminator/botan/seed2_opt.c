...
static __MSALIGN__(16) struct l_array_24_uint8_t _ZL6in_key __attribute__((aligned(16))) = { "\x9E\x37y\xB9\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" };
