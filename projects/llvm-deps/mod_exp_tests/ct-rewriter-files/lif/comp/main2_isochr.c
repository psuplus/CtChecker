...
int main(void) {
  ...
  __MSALIGN__(16) struct l_array_32_uint32_t _3 __attribute__((aligned(16)));    /* Address-exposed local */
...
_15:
  _6 = _4;
  if ((((((uint64_t)_6) < ((uint64_t)UINT64_C(32)))&1))) {
    goto _16;
  } else {
    goto _17;
  }
...
_17:
  *((&_3.array[((int64_t)0)])) = -1;
  _12 = comp(((&_2.array[((int64_t)0)])), 32, ((&_3.array[((int64_t)0)])), 32);
  _5 = _12;
  _13 = _5;
