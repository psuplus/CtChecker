...
void _gcry_mpi_powm (gcry_mpi_t w,
                    ...
                    const gcry_mpi_t m, int pub_int0,int pub_int1,int pub_int2,mpi_limb_t *pub_l0,
                    mpi_limb_t *pub_l1,mpi_limb_t *pub_l2,mpi_limb_t *pub_l3,mpi_limb_t *pub_l4,
                    mpi_limb_t *pub_l5,mpi_limb_t *pub_l6,mpi_limb_t *pub_l7,mpi_limb_t pub_l8,
                    int pub_branch0,int pub_branch1,int pub_branch2,int pub_branch3,int pub_branch4,
                    int pub_branch5,int pub_branch6,int pub_branch7,int pub_branch8,int pub_branch9,
                    int pub_branch10,int pub_branch11,int pub_branch12,int pub_branch13,int pub_branch14,
                    int pub_branch15,int pub_branch16,int pub_branch17,int pub_branch18,int pub_branch19,
                    int pub_branch20,int pub_branch21,int pub_branch22,int pub_branch23,int pub_branch24);
