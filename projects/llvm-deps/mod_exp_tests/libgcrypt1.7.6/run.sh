...
$LEVEL/Debug+Asserts/bin/clang -isystem include -O0 -g -emit-llvm -o ../mpi-pow.bc -c mpi-pow.c
$LEVEL/Debug+Asserts/bin/clang -isystem inlcude -O0 -g -emit-llvm -S mpi-pow.c
...
$LEVEL/Debug+Asserts/bin/opt  -load $LEVEL/projects/poolalloc/Debug+Asserts/lib/LLVMDataStructure.$EXT \
  ...
  -vulnerablebranch  -debug < ../mpi-pow.bc > /dev/null
