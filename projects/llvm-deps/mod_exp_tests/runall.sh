...
ct_verif_tests()
{
    ...
    execute_ct_verif "ct-verif-files/mbedtls3.2.1" "./run.sh" "v4_min_test.bc" $OUT_MIN_DIR "v4"
    execute_ct_verif "ct-verif-files/mbedtls3.2.1" "./run.sh" "v2_min_test.bc" $OUT_MIN_DIR "v3"
    execute_ct_verif "ct-verif-files/mbedtls3.2.1" "./run.sh" "v1_min_test.bc" $OUT_MIN_DIR "v2"
