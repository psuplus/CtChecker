...
\begin{table*}[!t]
  ...
  \begin{tabular}{@{}lcrrrrcrrrr@{}}
    ...
    \bottomrule
  \end{tabular}
\caption{Number of Positives in Ct-verif and CTChecker}
\label{tbl:runtimes}
\end{table*}

The paper of Almeida et al. uses an approach based on a reduction of the security of a program P to the
assertion-safety of a program Q \cite{almeida2016verifying}.  The reduction is inspired by prior work on
self-composition and product programs.  A product program Q verifies the security
of P by simulating two executions in lockstep.   It asserts the equality of each
...
We did not include the full source for the libraries (except for BearSSL).
...
whose parameter is tainted.  In constrast, ct-verif taints the return value
