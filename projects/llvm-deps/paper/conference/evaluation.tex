...
three versions (version 1, version 2 and version 3), each of which was
developed from the version number before it.

First, a baseline version (version 1) was created to bridge the gap between
...
The second version (version 2) was constructed from the first, the reasons are
...
The third version was created from the second to remove all erroneous
