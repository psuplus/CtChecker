...
with some undefined values. … Assignment statements with excluded
source were rewritten to assign the variable to a public or private
...
counted the same for each tool, and were only introduced in OpenSSL.
...
of the total positives reported on each version. No positives were
introduced from loops in CtChecker, as expected.
