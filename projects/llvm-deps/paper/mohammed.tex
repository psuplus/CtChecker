...
improved analysis will be referred to as the improved analysis. The changes made
from the baseline to the improved analysis were done to improve the field
sensitivity. The system works by generating constraints for each value that is
extracted from the control flow of a program. By creating the constraint
