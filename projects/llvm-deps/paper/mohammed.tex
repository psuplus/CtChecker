...
\begin{table}
  ...
  \begin{tabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
    ...
    \hline
    \textbf{Libgcrypt 1.8.2} & 68 & 36 & 1 & 21 & 10\\
...
\begin{table}
  ...
  \begin{tabular}{|p{2cm} | p{2cm}| p{2cm} |p{2cm}| p{2cm}| p{2cm}| p{2cm}|}
    \hline
    \textbf{Library} &\textbf{TP}&\textbf{TP\textsubscript{WL}} & \textbf{FP}&\textbf{V}&\textbf{LR}&\textbf{HR}\\
    \hline
    \textbf{Libgcrypt 1.8.2} & 34 & 18 &  3 & 1 & 5 & 8\\
    \textbf{mbedTLS 2.9.0} & 25  & 22 & 8  & 0 & 10 & 4 \\
    \textbf{BearSSL 0.5}& 10 & 3& 3 & 0 & 0 & 0 \\
    \textbf{OpenSSL 1.1.0g}& & & & & \\
    Reciprocal &24 & 13 & 4  & 6 & 1 & 2 \\
    Montgomery &34 & 25 & 4   & 11   & 6  &  4  \\
    Montgomery Const. Time & 30 & 21 & 0   & 12    &  7   &  2  \\
    Montgomery Word &22 & 20 & 3   & 11    & 2    & 4   \\
    Simple & 22 & 11 & 2    & 6    & 1    & 2   \\
    \hline
  \end{tabular}}
